<?php
    ...
    if (isset($_POST['submit'])) {
        try {
            ...
            $lastName = $_POST['lname']; // Assuming the name attribute for Last Name is 'lname'
            $gender = $_POST['gender'];
            $contactNo = $_POST['contact'];
            $email = $_POST['email'];
            $password = md5($_POST['password']); // Encrypting password using MD5
        
            // SQL query to insert data into userRegistration table
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    ...
                    <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Register New student</h4>
            ...
            <form method="POST" name="" onSubmit="return valid();">
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Last Name</h4>
                    <div class="form-group">
                        <input type="text" name="mname" id="mname" placeholder="Enter last Name" required class="form-control">
                    </div>
            </div>
        </div>
    </div>
